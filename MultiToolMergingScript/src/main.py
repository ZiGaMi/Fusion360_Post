...
def write_header(file, parsed_files):
    ...
    header =   "( Copyright (c) 2022 Ziga Miklosic )\n\
                ( All Rights Reserved )\n\
                ( This file is automatically generated file by MultiToolMergingScript )\n\
                ( Merging script version: %s)\n\
                \n\
                ( ================================================ )\n\
                ( Post script version: %s )\n\
                ( ================================================ )\n\
                ( File:   %s )\n\
                ( Author: %s )\n\
                ( Date:   %s )\n\
                ...
                ( Brief:  %s )\n\
                ( ================================================ )"\
                % ( SCRIPT_VERSION, parsed_files[0].get_post_ver(), parsed_files[0].get_file_name(), \
                    parsed_files[0].get_author(), parsed_files[0].get_date_time()[0], parsed_files[0].get_date_time()[1], parsed_files[0].get_brief())
